...
public class GeomancyHelper {
	...
	public static final int[][] CONFIG_1_ROWS = new int[][] { CONFIG_1_NORTH_ROW, CONFIG_1_EAST_ROW, CONFIG_1_SOUTH_ROW,
			CONFIG_1_WEST_ROW };
	...
	public static final int[][] CONFIG_2_ROWS = new int[][] { CONFIG_2_NORTH_ROW, CONFIG_2_EAST_ROW, CONFIG_2_SOUTH_ROW,
			CONFIG_2_WEST_ROW };
	...
	private static BlockPos createCenteredBlockPosOnTarget(Entity targetEntity) {
		return new BlockPos(Math.floor(targetEntity.getX()), Math.floor(targetEntity.getY()),
	...
	private static void summonAreaDenialVine(LivingEntity casterEntity, LivingEntity targetEntity,
			EntityType<? extends AbstractVineEntity> entityType, double xshift, double zshift, Direction pillarFacing) {
		BlockPos targetPos = createCenteredBlockPosOnTarget(targetEntity).offset(xshift, 0, zshift);
		// verify that the construct will be summoned on valid ground
		if (canAllowBlockEntitySpawn(casterEntity, targetPos)) {
			AbstractVineEntity vineEntity = entityType.create(casterEntity.level);
	...
	public static void summonRandomPillarsTrap(LivingEntity casterEntity, BlockPos targetPos,
		...
		for (int length = 0; length < 25; length++) {
			summonAreaDenialConstruct(casterEntity, targetPos, entityType, -8 + casterEntity.getRandom().nextInt(16),
