...
public class MobEnchantmentAncientData {
	...
	public static final Codec<MobEnchantmentAncientData> CODEC = RecordCodecBuilder.create(builder -> builder
			.group(Codec.STRING.listOf().optionalFieldOf("adjectives", defaultAdjectives)
