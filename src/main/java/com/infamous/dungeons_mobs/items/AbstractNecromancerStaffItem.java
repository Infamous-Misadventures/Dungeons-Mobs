...
public abstract class AbstractNecromancerStaffItem extends AbstractStaffItem {
	...
	private void shoot(Player playerIn, ItemStack itemStack, InteractionHand hand, double targetX, double targetY,
			double targetZ) {
	...
	protected abstract Projectile createOrb(Player playerIn, double xDifference, double yDifference,
			double zDifference);
}
