...
public class ShieldTextures {
    ...
    public static final RenderMaterial LOCATION_vanguard_shield = new RenderMaterial(AtlasTexture.LOCATION_BLOCKS, new ResourceLocation(MODID,"entity/shield/vanguard_shield"));
