...
//        public final ForgeConfigSpec.ConfigValue<List<? extends String>> ROYAL_GUARD_BIOME_TYPES;
		...
		public Common(ForgeConfigSpec.Builder builder) {
			...
			ENABLE_WRAITH_FIRE_SUMMON = builder.comment(
			...
			NECROMANCER_MOB_SUMMONS = builder
					...
					.defineList("necromancerMobSummons", Lists.newArrayList("minecraft:zombie", "minecraft:skeleton"),
			...
			DROWNED_NECROMANCER_MOB_SUMMONS = builder
					...
					.defineList("drownedNecromancerMobSummons",
							Lists.newArrayList("minecraft:drowned", "dungeons_mobs:sunken_skeleton"),
							(itemRaw) -> itemRaw instanceof String);
			...
			ICEOLOGER_BIOME_TYPES = builder
					...
					.defineList("iceologerBiomeTypes", Lists.newArrayList("SNOWY", "!MUSHROOM", "!NETHER", "!END"),
							(itemRaw) -> itemRaw instanceof String);
			...
			WRAITH_BIOME_TYPES = builder.comment("Add biome types that the Wraith can spawn in. \n"
					+ "Put a \"!\" before the type to prevent spawning in that biome type. \n"
					+ "Leave this blank if you don't want them to spawn at all.").defineList("wraithBiomeTypes",
							Lists.newArrayList("OVERWORLD", "!MUSHROOM", "!NETHER", "!END"),
							(itemRaw) -> itemRaw instanceof String);
			...
			NECROMANCER_BIOME_TYPES = builder
					.comment("Add biome types that the Necromancer can spawn in. \n"
							+ "Put a \"!\" before the type to prevent spawning in that biome type. \n"
							+ "Leave this blank if you don't want them to spawn at all.")
					.defineList("necromancerBiomeTypes", Lists.newArrayList("SANDY", "!MUSHROOM", "!NETHER", "!END"),
							(itemRaw) -> itemRaw instanceof String);
			...
			SKELETON_VANGUARD_BIOME_TYPES = builder
					.comment("Add biome types that the Skeleton Vanguard can spawn in. \n"
							+ "Put a \"!\" before the type to prevent spawning in that biome type. \n"
							+ "Leave this blank if you don't want them to spawn at all.")
					.defineList("skeletonVanguardBiomeTypes",
							Lists.newArrayList("OVERWORLD", "DESERT", "!MUSHROOM", "!NETHER", "!END"),
							(itemRaw) -> itemRaw instanceof String);
			...
			SKELETON_VANGUARD_MIN_GROUP_SIZE = builder.comment(
					"Minimum spawn group size of Skeleton Vanguard in the locations they can spawn in. [default:1]")
					.defineInRange("skeletonVanguardMinGroupSize", 1, 0, 32);
			SKELETON_VANGUARD_MAX_GROUP_SIZE = builder.comment(
					"Maximum spawn group size of Skeleton Vanguard in the locations they can spawn in. [default:1]")
			...
			MOUNTAINEER_BIOME_TYPES = builder
					.comment("Add biome types that the Mountaineer can spawn in. \n"
							+ "Put a \"!\" before the type to prevent spawning in that biome type. \n"
							+ "Leave this blank if you don't want them to spawn at all.")
					.defineList("mountaineerBiomeTypes", Lists.newArrayList("MOUNTAIN", "!SANDY", "!JUNGLE", "!FOREST",
							"!MUSHROOM", "!HOT", "!NETHER", "!END"), (itemRaw) -> itemRaw instanceof String);
			...
			WINDCALLER_BIOME_TYPES = builder
					.comment("Add biome types that the Windcaller can spawn in. \n"
							+ "Put a \"!\" before the type to prevent spawning in that biome type. \n"
							+ "Leave this blank if you don't want them to spawn at all.")
					.defineList("windcallerBiomeTypes", Lists.newArrayList("MOUNTAIN", "!SANDY", "!JUNGLE", "!FOREST",
							"!MUSHROOM", "!HOT", "!NETHER", "!END"), (itemRaw) -> itemRaw instanceof String);
			...
			GEOMANCER_BIOME_TYPES = builder
					.comment("Add biome types that the Geomancer can spawn in. \n"
							+ "Put a \"!\" before the type to prevent spawning in that biome type. \n"
							+ "Leave this blank if you don't want them to spawn at all.")
					.defineList("geomancerBiomeTypes", Lists.newArrayList("SAVANNA", "!MUSHROOM", "!NETHER", "!END"),
							(itemRaw) -> itemRaw instanceof String);
			...
			ILLUSIONER_BIOME_TYPES = builder
					.comment("Add biome types that the Illusioner can spawn in. \n"
							...
							+ "Leave this blank if you don't want them to spawn at all.")
					.defineList(
							"illusionerBiomeTypes", Lists.newArrayList("SNOWY", "MOUNTAIN", "!SANDY", "!JUNGLE",
									"!FOREST", "!HOT", "!MUSHROOM", "!NETHER", "!END"),
							(itemRaw) -> itemRaw instanceof String);
			...
			VINDICATOR_BIOME_TYPES = builder
					.comment("Add biome types that the Vindicator can spawn in. \n"
							+ "Put a \"!\" before the type to prevent spawning in that biome type. \n"
							+ "Leave this blank if you don't want them to spawn at all.")
					.defineList("vindicatorBiomeTypes", Lists.newArrayList("SPOOKY", "!MUSHROOM", "!NETHER", "!END"),
							(itemRaw) -> itemRaw instanceof String);
			...
			EVOKER_BIOME_TYPES = builder.comment("Add biome types that the Evoker can spawn in. \n"
					+ "Put a \"!\" before the type to prevent spawning in that biome type. \n"
					+ "Leave this blank if you don't want them to spawn at all.").defineList("evokerBiomeTypes",
							Lists.newArrayList("SPOOKY", "!MUSHROOM", "!NETHER", "!END"),
							(itemRaw) -> itemRaw instanceof String);
			...
			PILLAGER_BIOME_TYPES = builder
					.comment("Add biome types that the Pillager can spawn in. \n"
							+ "Put a \"!\" before the type to prevent spawning in that biome type. \n"
							+ "Leave this blank if you don't want them to spawn at all.")
					.defineList("pillagerBiomeTypes", Lists.newArrayList("SPOOKY", "!MUSHROOM", "!NETHER", "!END"),
							(itemRaw) -> itemRaw instanceof String);
			 ...
			 * "Put a \"!\" before the type to prevent spawning in that biome type. \n" +
			 * "Leave this blank if you don't want them to spawn at all.")
			 * .defineList("royalGuardBiomeTypes", Lists.newArrayList( "SPOOKY",
			 * "!MUSHROOM", "!NETHER", "!END" ), (itemRaw) -> itemRaw instanceof String);
			 */
			...
			WHISPERER_BIOME_TYPES = builder
					.comment("Add biome types that the Whisperer can spawn in. \n"
							+ "Put a \"!\" before the type to prevent spawning in that biome type. \n"
							+ "Leave this blank if you don't want them to spawn at all.")
					.defineList("whispererBiomeTypes", Lists.newArrayList("JUNGLE", "!MUSHROOM", "!NETHER", "!END"),
							(itemRaw) -> itemRaw instanceof String);
			...
			LEAPLEAF_BIOME_TYPES = builder
					.comment("Add biome types that the Leapleaf can spawn in. \n"
							+ "Put a \"!\" before the type to prevent spawning in that biome type. \n"
							+ "Leave this blank if you don't want them to spawn at all.")
					.defineList("leapleafBiomeTypes", Lists.newArrayList("JUNGLE", "!MUSHROOM", "!NETHER", "!END"),
							(itemRaw) -> itemRaw instanceof String);
			...
			QUICK_GROWING_VINE_BIOME_TYPES = builder
					.comment("Add biome types that the Quick-Growing Vines can spawn in. \n"
							+ "Put a \"!\" before the type to prevent spawning in that biome type. \n"
							+ "Leave this blank if you don't want them to spawn at all.")
					.defineList("quickGrowingVineBiomeTypes",
							Lists.newArrayList("JUNGLE", "!MUSHROOM", "!NETHER", "!END"),
							(itemRaw) -> itemRaw instanceof String);
			...
			QUICK_GROWING_VINE_MIN_GROUP_SIZE = builder.comment(
					"Minimum spawn group size of Quick-Growing Vines in the locations they can spawn in. [default:1]")
					.defineInRange("quickGrowingVineMinGroupSize", 1, 0, 128);
			QUICK_GROWING_VINE_MAX_GROUP_SIZE = builder.comment(
					"Maximum spawn group size of Quick-Growing Vines in the locations they can spawn in. [default:1]")
			...
			POISON_QUILL_VINE_BIOME_TYPES = builder
					.comment("Add biome types that the Poison-Quill Vines can spawn in. \n"
							+ "Put a \"!\" before the type to prevent spawning in that biome type. \n"
							+ "Leave this blank if you don't want them to spawn at all.")
					.defineList("poisonQuillVineBiomeTypes",
							Lists.newArrayList("JUNGLE", "!MUSHROOM", "!NETHER", "!END"),
							(itemRaw) -> itemRaw instanceof String);
			...
			POISON_QUILL_VINE_MIN_GROUP_SIZE = builder.comment(
					"Minimum spawn group size of Poison-Quill Vines in the locations they can spawn in. [default:1]")
					.defineInRange("poisonQuillVineMinGroupSize", 1, 0, 128);
			POISON_QUILL_VINE_MAX_GROUP_SIZE = builder.comment(
					"Maximum spawn group size of Poison-Quill Vines in the locations they can spawn in. [default:1]")
			...
			FUNGUS_THROWER_BIOME_TYPES = builder
					.comment("Add biome types that the Fungus Thrower can spawn in. \n"
							+ "Put a \"!\" before the type to prevent spawning in that biome type. \n"
							+ "Leave this blank if you don't want them to spawn at all.")
					.defineList("fungusThrowerBiomeTypes", Lists.newArrayList("NETHER", "CRIMSON", "!WARPED",
							"!SOULSAND", "!DELTA", "!OVERWORLD", "!END"), (itemRaw) -> itemRaw instanceof String);
			...
			FUNGUS_THROWER_MIN_GROUP_SIZE = builder.comment(
					"Minimum spawn group size of Fungus Throwers in the locations they can spawn in. [default:3]")
					.defineInRange("fungusThrowerMinGroupSize", 3, 0, 128);
			FUNGUS_THROWER_MAX_GROUP_SIZE = builder.comment(
					"Maximum spawn group size of Fungus Throwers in the locations they can spawn in. [default:4]")
			...
			ZOMBIFIED_FUNGUS_THROWER_BIOME_TYPES = builder
					.comment("Add biome types that the Zombified Fungus Thrower can spawn in. \n"
							...
							+ "Leave this blank if you don't want them to spawn at all.")
					.defineList(
							"zombifiedFungusThrowerBiomeTypes", Lists.newArrayList("NETHER", "CRIMSON", "!WARPED",
									"!SOULSAND", "!DELTA", "!OVERWORLD", "!END"),
							(itemRaw) -> itemRaw instanceof String);
			ZOMBIFIED_FUNGUS_THROWER_SPAWN_WEIGHT = builder
					.comment(
							"Spawn weight of Zombified Fungus Throwers in the locations they can spawn in. [default:5]")
					.defineInRange("zombifiedFungusThrowerSpawnWeight", 5, 0, 1024);
			ZOMBIFIED_FUNGUS_THROWER_MIN_GROUP_SIZE = builder.comment(
					"Minimum spawn group size of Zombified Fungus Throwers in the locations they can spawn in. [default:3]")
					.defineInRange("zombifiedFungusThrowerMinGroupSize", 3, 0, 128);
			ZOMBIFIED_FUNGUS_THROWER_MAX_GROUP_SIZE = builder.comment(
					"Maximum spawn group size of Zombified Fungus Throwers in the locations they can spawn in. [default:4]")
			...
			WITHER_SKELETON_BIOME_TYPES = builder
					.comment("Add biome types that the Wither Skeleton can spawn in. \n"
							+ "Put a \"!\" before the type to prevent spawning in that biome type. \n"
							+ "Leave this blank if you don't want them to spawn at all.")
					.defineList("witherSkeletonBiomeTypes", Lists.newArrayList("NETHER", "SOULSAND", "!CRIMSON",
							"!WARPED", "!DELTA", "!OVERWORLD", "!END"), (itemRaw) -> itemRaw instanceof String);
			...
			WITHER_SKELETON_MIN_GROUP_SIZE = builder.comment(
					"Minimum spawn group size of Wither Skeletons in the locations they can spawn in. [default:1]")
					.defineInRange("witherSkeletonMinGroupSize", 1, 0, 128);
			WITHER_SKELETON_MAX_GROUP_SIZE = builder.comment(
					"Maximum spawn group size of Wither Skeletons in the locations they can spawn in. [default:4]")
			...
			SUNKEN_SKELETON_BIOME_TYPES = builder
					.comment("Add biome types that the Sunken Skeleton can spawn in. \n"
							+ "Put a \"!\" before the type to prevent spawning in that biome type. \n"
							+ "Leave this blank if you don't want them to spawn at all.")
					.defineList("sunkenSkeletonBiomeTypes", Lists.newArrayList("WATER", "!MUSHROOM", "!NETHER", "!END"),
							(itemRaw) -> itemRaw instanceof String);
			...
			SUNKEN_SKELETON_MIN_GROUP_SIZE = builder.comment(
					"Minimum spawn group size of Sunken Skeletons in the locations they can spawn in. [default:1]")
					.defineInRange("sunkenSkeletonMinGroupSize", 1, 0, 128);
			SUNKEN_SKELETON_MAX_GROUP_SIZE = builder.comment(
					"Maximum spawn group size of Sunken Skeletons in the locations they can spawn in. [default:4]")
			...
			DROWNED_NECROMANCER_BIOME_TYPES = builder
					.comment("Add biome types that the Drowned Necromancer can spawn in. \n"
							+ "Put a \"!\" before the type to prevent spawning in that biome type. \n"
							+ "Leave this blank if you don't want them to spawn at all.")
					.defineList("drownedNecromancerBiomeTypes",
							Lists.newArrayList("OCEAN", "!MUSHROOM", "!NETHER", "!END"),
							(itemRaw) -> itemRaw instanceof String);
			...
			DROWNED_NECROMANCER_MIN_GROUP_SIZE = builder.comment(
					"Minimum spawn group size of Drowned Necromancers in the locations they can spawn in. [default:1]")
					.defineInRange("drownedNecromancerMinGroupSize", 1, 0, 128);
			DROWNED_NECROMANCER_MAX_GROUP_SIZE = builder.comment(
					"Maximum spawn group size of Drowned Necromancers in the locations they can spawn in. [default:4]")
			...
			WAVEWHISPERER_BIOME_TYPES = builder
					.comment("Add biome types that the Wavehisperer can spawn in. \n"
							+ "Put a \"!\" before the type to prevent spawning in that biome type. \n"
							+ "Leave this blank if you don't want them to spawn at all.")
					.defineList("wavewhispererBiomeTypes", Lists.newArrayList("OCEAN", "!MUSHROOM", "!NETHER", "!END"),
							(itemRaw) -> itemRaw instanceof String);
			...
			WAVEWHISPERER_MIN_GROUP_SIZE = builder
					.comment(
							"Minimum spawn group size of Wavehisperers in the locations they can spawn in. [default:1]")
					.defineInRange("wavewhispererMinGroupSize", 1, 0, 128);
			WAVEWHISPERER_MAX_GROUP_SIZE = builder
					.comment(
							"Maximum spawn group size of Wavehisperers in the locations they can spawn in. [default:4]")
			...
			QUICK_GROWING_ANEMONE_BIOME_TYPES = builder
					.comment("Add biome types that the Quick-Growing Anemone can spawn in. \n"
							+ "Put a \"!\" before the type to prevent spawning in that biome type. \n"
							+ "Leave this blank if you don't want them to spawn at all.")
					.defineList("quickGrowingAnemoneBiomeTypes",
							Lists.newArrayList("OCEAN", "!MUSHROOM", "!NETHER", "!END"),
							(itemRaw) -> itemRaw instanceof String);
			...
			QUICK_GROWING_ANEMONE_MIN_GROUP_SIZE = builder.comment(
					"Minimum spawn group size of Quick-Growing Anemone in the locations they can spawn in. [default:1]")
					.defineInRange("quickGrowingAnemoneMinGroupSize", 1, 0, 128);
			QUICK_GROWING_ANEMONE_MAX_GROUP_SIZE = builder.comment(
					"Maximum spawn group size of Quick-Growing Anemone in the locations they can spawn in. [default:1]")
			...
			POISON_ANEMONE_BIOME_TYPES = builder
					.comment("Add biome types that the Poison Anemone can spawn in. \n"
							+ "Put a \"!\" before the type to prevent spawning in that biome type. \n"
							+ "Leave this blank if you don't want them to spawn at all.")
					.defineList("poisonAnemoneBiomeTypes", Lists.newArrayList("OCEAN", "!MUSHROOM", "!NETHER", "!END"),
							(itemRaw) -> itemRaw instanceof String);
			...
			POISON_ANEMONE_MIN_GROUP_SIZE = builder.comment(
					"Minimum spawn group size of Poison Anemone in the locations they can spawn in. [default:1]")
					.defineInRange("poisonAnemoneMinGroupSize", 1, 0, 128);
			POISON_ANEMONE_MAX_GROUP_SIZE = builder.comment(
					"Maximum spawn group size of Poison Anemone in the locations they can spawn in. [default:1]")
			...
			ENDERLING_BIOME_TYPES = builder
					.comment("Add biome types that the Enderlings can spawn in. \n"
							+ "Put a \"!\" before the type to prevent spawning in that biome type. \n"
							+ "Leave this blank if you don't want them to spawn at all.")
					.defineList("enderlingBiomeTypes", Lists.newArrayList("END", "!END_CENTER"),
							(itemRaw) -> itemRaw instanceof String);
			...
			ENABLE_OUTPOST_VANILLA_VINDICATOR = builder.comment(
					"Enables logic for allowing vindicators to spawn in Outposts. Defaults to true [true / false]")
					.define("enableOutpostVanillaVindicator", true);
			ENABLE_OUTPOST_VANILLA_EVOKER = builder
					.comment(
							"Enables logic for allowing evokers to spawn in Outposts. Defaults to false [true / false]")
					.define("enableOutpostVanillaEvoker", false);
			ENABLE_OUTPOST_DUNGEONS_MOBS_MELEE = builder.comment(
					"Enables logic for allowing melee Dungeons Mobs to spawn in Outposts. Defaults to true [true / false]")
					.define("enableOutpostDungeonsMobsMelee", true);
			ENABLE_OUTPOST_DUNGEONS_MOBS_CASTER = builder.comment(
					"Enables logic for allowing caster Dungeons Mobs to spawn in Outposts. Defaults to false [true / false]")
					.define("enableOutpostDungeonsMobsCaster", false);
			ENABLE_MANSION_VANILLA = builder.comment(
					"Enables logic for allowing vanilla mobs to spawn in Mansions. Defaults to true [true / false]")
					.define("enableMansionVanilla", true);
			ENABLE_MANSION_DUNGEONS_MOBS = builder.comment(
					"Enables logic for allowing Dungeons Mobs to spawn in Mansions. Defaults to true [true / false]")
					.define("enableMansionDungeonsMobs", true);
			ENABLE_BASTION_VANILLA = builder.comment(
					"Enables logic for allowing vanilla mobs to spawn in Bastions. Defaults to true [true / false]")
					.define("enableBastionVanilla", true);
			ENABLE_BASTION_DUNGEONS_MOBS = builder.comment(
					"Enables logic for allowing Dungeons Mobs to spawn in Bastions. Defaults to true [true / false]")
					.define("enableBastionDungeonsMobs", true);
			ENABLE_NETHER_FORTRESS_DUNGEONS_MOBS = builder.comment(
					"Enables logic for allowing Dungeons Mobs to spawn in Nether Fortresses. Defaults to true [true / false]")
					.define("enableNetherFortressDungeonsMobs", true);
			ENABLE_DESERT_PYRAMID_DUNGEONS_MOBS = builder.comment(
					"Enables logic for allowing Dungeons Mobs to spawn in Desert Pyramids. Defaults to true [true / false]")
					.define("enableDesertPyramidDungeonsMobs", true);
			ENABLE_JUNGLE_TEMPLE_DUNGEONS_MOBS = builder.comment(
					"Enables logic for allowing Dungeons Mobs to spawn in Jungle Temples. Defaults to true [true / false]")
			...
			ENABLE_BIOME_SPECIFIC_RAIDERS = builder.comment(
			...
			SQUALL_GOLEM_BIOME_TYPES = builder.comment(
					...
					.defineList(
							"squallGolemBiomeTypes", Lists.newArrayList("MOUNTAIN", "!SANDY", "!JUNGLE", "!FOREST",
									"!MUSHROOM", "!HOT", "!MUSHROOM", "!NETHER", "!END"),
							(itemRaw) -> itemRaw instanceof String);
			...
			ENABLE_GEOMANCERS_IN_RAIDS = builder.comment("Enable the addition of Geomancers to raids. [true / false]")
					.define("enableGeomancersInRaids", true);
			ENABLE_ILLUSIONERS_IN_RAIDS = builder.comment("Enable the addition of Illusioners to raids. [true / false]")
					.define("enableIllusionersInRaids", false);
			ENABLE_MAGES_IN_RAIDS = builder.comment("Enable the addition of Mages to raids. [true / false]")
					.define("enableMagesInRaids", false);
			ENABLE_ICEOLOGERS_IN_RAIDS = builder.comment("Enable the addition of Iceologers to raids. [true / false]")
					.define("enableIceologersInRaids", false);
			ENABLE_WINDCALLERS_IN_RAIDS = builder.comment("Enable the addition of Windcallers to raids. [true / false]")
			...
			ENABLE_STRONGER_HUSKS = builder.comment(
			...
			ENABLE_RANGED_SPIDERS = builder.comment(
