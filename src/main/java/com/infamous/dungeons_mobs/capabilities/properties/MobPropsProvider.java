...
public class MobPropsProvider implements ICapabilitySerializable<INBT> {

    @CapabilityInject(IMobProps.class)
    public static final Capability<IMobProps> MOB_PROPS_CAPABILITY = null;

    private LazyOptional<IMobProps> instance = LazyOptional.of(MOB_PROPS_CAPABILITY::getDefaultInstance);
