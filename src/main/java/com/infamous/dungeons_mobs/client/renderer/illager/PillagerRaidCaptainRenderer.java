...
public class PillagerRaidCaptainRenderer extends GeoEntityRenderer<PillagerRaidCaptainEntity> {

	private static final Map<String, ResourceLocation> ARMOR_LOCATION_CACHE = Maps.newHashMap();
	public PillagerRaidCaptainEntity thisMage;
	public PillagerRaidCaptainRenderer(EntityRendererManager renderManager) {
	...
	protected void applyRotations(PillagerRaidCaptainEntity entityLiving, MatrixStack matrixStackIn, float ageInTicks,
								  float rotationYaw, float partialTicks) {
		float scaleFactor = 1.1375F;
		matrixStackIn.scale(scaleFactor, scaleFactor, scaleFactor);
		super.applyRotations(entityLiving, matrixStackIn, ageInTicks, rotationYaw, partialTicks);
	}

	@Override
	public RenderType getRenderType(PillagerRaidCaptainEntity animatable, float partialTicks, MatrixStack stack,
									IRenderTypeBuffer renderTypeBuffer, IVertexBuilder vertexBuilder, int packedLightIn,
									ResourceLocation textureLocation) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}
	@Override
	public void render(PillagerRaidCaptainEntity entity, float entityYaw, float partialTicks, MatrixStack stack,
 ...
 */
	...
	public Integer getUniqueID(PillagerRaidCaptainEntity animatable) {
