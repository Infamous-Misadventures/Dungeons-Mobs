...
public class DungeonVindicatorRenderer extends GeoEntityRenderer<DungeonsVindicatorEntity> {
	...
	public DungeonsVindicatorEntity thisMage;
	...
	@Override
	public void render(DungeonsVindicatorEntity entity, float entityYaw, float partialTicks, MatrixStack stack,
	...
	public void renderRecursively(GeoBone bone, MatrixStack stack, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
		bufferIn = rtb.getBuffer(RenderType.entityTranslucent(new ResourceLocation(DungeonsMobs.MODID, "textures/geo_entity/illager/vindicator.png")));
	...
	public Integer getUniqueID(DungeonsVindicatorEntity animatable) {
