...
public class GeomancerRenderer extends GeoEntityRenderer<GeomancerEntity> {
	...
	public GeomancerEntity thisMage;

	@Override
	public void render(GeomancerEntity entity, float entityYaw, float partialTicks, MatrixStack stack,
	...
	public void renderRecursively(GeoBone bone, MatrixStack stack, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
		bufferIn = rtb.getBuffer(RenderType.entityTranslucent(
				new ResourceLocation(DungeonsMobs.MODID, "textures/geo_entity/illager/geomancer.png")));
