...
public class ArmoredMountaineerRenderer extends GeoEntityRenderer<ArmoredMountaineerEntity> {
	...
	public ArmoredMountaineerEntity thisMage;
	...
	@Override
	public void render(ArmoredMountaineerEntity entity, float entityYaw, float partialTicks, MatrixStack stack,
	...
	public void renderRecursively(GeoBone bone, MatrixStack stack, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
		bufferIn = rtb.getBuffer(RenderType.entityTranslucent(thisMage.isDiamond() ?
				new ResourceLocation(DungeonsMobs.MODID, "textures/geo_entity/illager/diamond_armored_mountaineer.png") :
				new ResourceLocation(DungeonsMobs.MODID, "textures/geo_entity/illager/gold_armored_mountaineer.png")));
	...
	public Integer getUniqueID(ArmoredMountaineerEntity animatable) {
