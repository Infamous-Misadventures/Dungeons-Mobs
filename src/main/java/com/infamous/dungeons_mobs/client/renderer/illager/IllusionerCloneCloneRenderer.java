...
import com.infamous.dungeons_mobs.client.models.illager.MinecraftIllusionerModel;
...
public class IllusionerCloneCloneRenderer extends GeoEntityRenderer<IllusionerCloneCloneEntity> {
	public IllusionerCloneCloneRenderer(EntityRendererManager renderManager) {
		super(renderManager, new MinecraftIllusionerModel());
	...
	protected void applyRotations(IllusionerCloneCloneEntity entityLiving, MatrixStack matrixStackIn, float ageInTicks,
	...
	@Override
	public RenderType getRenderType(IllusionerCloneCloneEntity animatable, float partialTicks, MatrixStack stack,
	...
	public IllusionerCloneCloneEntity thisMage;

	@Override
	public void render(IllusionerCloneCloneEntity entity, float entityYaw, float partialTicks, MatrixStack stack,
	...
	public void renderRecursively(GeoBone bone, MatrixStack stack, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
		bufferIn = rtb.getBuffer(RenderType.entityTranslucent(
				new ResourceLocation(DungeonsMobs.MODID, "textures/geo_entity/illusioner.png")));
		...
		if (bone.getName().equals("armourLeftArm2")) { // rArmRuff is the name of the bone you to set the item to attach too. Please see Note
			bufferIn = rtb.getBuffer(RenderType.entityTranslucent(whTexture));
			if (this.getArmorResource(thisMage, thisMage.getItemBySlot(EquipmentSlotType.CHEST), EquipmentSlotType.CHEST, null) != null) {
				bufferIn = rtb.getBuffer(RenderType.entityTranslucent((this.getArmorResource(thisMage, thisMage.getItemBySlot(EquipmentSlotType.CHEST), EquipmentSlotType.CHEST, null))));
			}
		...
		if (bone.getName().equals("armourRightArm2")) { // rArmRuff is the name of the bone you to set the item to attach too. Please see Note
			bufferIn = rtb.getBuffer(RenderType.entityTranslucent(whTexture));
			if (this.getArmorResource(thisMage, thisMage.getItemBySlot(EquipmentSlotType.CHEST), EquipmentSlotType.CHEST, null) != null) {
				bufferIn = rtb.getBuffer(RenderType.entityTranslucent((this.getArmorResource(thisMage, thisMage.getItemBySlot(EquipmentSlotType.CHEST), EquipmentSlotType.CHEST, null))));
			}
