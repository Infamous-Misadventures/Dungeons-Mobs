...
public class DungeonsCloneRenderer extends GeoEntityRenderer<IllusionerCloneEntity> {
	public DungeonsCloneRenderer(EntityRendererManager renderManager) {
	...
	public IllusionerCloneEntity thisMage;
	...
	public void renderRecursively(GeoBone bone, MatrixStack stack, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
		bufferIn = rtb.getBuffer(RenderType.entityTranslucent(
				new ResourceLocation(DungeonsMobs.MODID, "textures/geo_entity/illager/illusioner.png")));
