...
public class RampartCaptainRenderer extends GeoEntityRenderer<RampartCaptainEntity> {
	...
	public RampartCaptainEntity thisMage;
	...
	@Override
	public void render(RampartCaptainEntity entity, float entityYaw, float partialTicks, MatrixStack stack,
	...
	public void renderRecursively(GeoBone bone, MatrixStack stack, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
		bufferIn = rtb.getBuffer(RenderType.entityTranslucent(
						new ResourceLocation(DungeonsMobs.MODID, "textures/geo_entity/illager/diamond_armored_mountaineer_leader.png")));
	...
	public Integer getUniqueID(RampartCaptainEntity animatable) {
