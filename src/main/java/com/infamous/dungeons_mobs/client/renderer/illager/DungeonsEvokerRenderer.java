...
import com.infamous.dungeons_mobs.client.models.illager.DungeonEvokerModel;
...
public class DungeonsEvokerRenderer extends GeoEntityRenderer<DungeonsEvokerEntity> {
	public DungeonsEvokerRenderer(EntityRendererManager renderManager) {
		super(renderManager, new DungeonEvokerModel());
	...
	protected void applyRotations(DungeonsEvokerEntity entityLiving, MatrixStack matrixStackIn, float ageInTicks,
	...
	@Override
	public RenderType getRenderType(DungeonsEvokerEntity animatable, float partialTicks, MatrixStack stack,
	...
	public DungeonsEvokerEntity thisMage;

	@Override
	public void render(DungeonsEvokerEntity entity, float entityYaw, float partialTicks, MatrixStack stack,
	...
	public Integer getUniqueID(DungeonsEvokerEntity animatable) {
