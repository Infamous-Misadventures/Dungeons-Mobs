...
public class WildfireRenderer extends ExtendedGeoEntityRenderer<WildfireEntity> {
	public WildfireRenderer(EntityRendererProvider.Context renderManager) {
		...
		this.addLayer(new PulsatingGlowLayer<>(this,
				new ResourceLocation(DungeonsMobs.MODID, "textures/entity/blaze/wildfire.png"), 0.1F, 1.0F, 0.25F));
	}
	...
	@Override
	protected void preRenderItem(PoseStack stack, ItemStack item, String boneName, WildfireEntity currentEntity,
			IBone bone) {
	...
	@Override
	protected void postRenderItem(PoseStack matrixStack, ItemStack item, String boneName, WildfireEntity currentEntity,
			IBone bone) {
