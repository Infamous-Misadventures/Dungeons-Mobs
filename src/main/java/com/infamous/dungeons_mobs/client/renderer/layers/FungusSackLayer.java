...
public class FungusSackLayer<T extends LivingEntity, M extends EntityModel<T>> extends RenderLayer<T, M> {
	private static final ResourceLocation SACK_LOCATION = new ResourceLocation(DungeonsMobs.MODID,
			"textures/entity/fungus_sack.png");
	...
	public void render(PoseStack matrixStack, MultiBufferSource renderTypeBuffer, int p_225628_3_, T wearer,
		...
		if (shouldRender(itemstack, wearer)) {
			...
			this.fungusSackModel.renderToBuffer(matrixStack, ivertexbuilder, p_225628_3_, OverlayTexture.NO_OVERLAY,
					1.0F, 1.0F, 1.0F, 1.0F);
			matrixStack.popPose();
		}
	}
