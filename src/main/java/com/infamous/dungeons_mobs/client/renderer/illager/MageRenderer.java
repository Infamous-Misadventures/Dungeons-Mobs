...
public class MageRenderer extends ExtendedGeoEntityRenderer<MageEntity> {
    public MageRenderer(EntityRendererManager renderManager) {
        super(renderManager, new MageModel());
    }

    @Override
    protected void applyRotations(MageEntity entityLiving, MatrixStack matrixStackIn, float ageInTicks,
    ...
    @Override
    public RenderType getRenderType(MageEntity animatable, float partialTicks, MatrixStack stack,
    ...
    @Nullable
    @Override
    protected ResourceLocation getTextureForBone(String s, MageEntity windcallerEntity) {
        return null;
    }

	@Override
	protected ItemStack getHeldItemForBone(String boneName, MageEntity currentEntity) {
		switch (boneName) {
	...
	@Override
	protected void preRenderItem(MatrixStack stack, ItemStack item, String boneName, MageEntity currentEntity, IBone bone) {
	...
	@Override
	protected void postRenderItem(MatrixStack matrixStack, ItemStack item, String boneName, MageEntity currentEntity, IBone bone) {

	}
    
	@Override
	protected BlockState getHeldBlockForBone(String boneName, MageEntity currentEntity) {
		return null;
	}
    ...
    @Nullable
    @Override
    protected ItemStack getArmorForBone(String boneName, MageEntity currentEntity) {
        switch (boneName) {
    ...
    @Override
    protected EquipmentSlotType getEquipmentSlotForArmorBone(String boneName, MageEntity currentEntity) {
        switch (boneName) {
            case "armorBipedLeftFoot":
            case "armorBipedRightFoot":
