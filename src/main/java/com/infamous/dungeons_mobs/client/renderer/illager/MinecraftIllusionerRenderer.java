...
public class MinecraftIllusionerRenderer extends GeoEntityRenderer<MinecraftIllusionerEntity> {
	public MinecraftIllusionerRenderer(EntityRendererManager renderManager) {
	...
	protected void applyRotations(MinecraftIllusionerEntity entityLiving, MatrixStack matrixStackIn, float ageInTicks,
	...
	@Override
	public RenderType getRenderType(MinecraftIllusionerEntity animatable, float partialTicks, MatrixStack stack,
	...
	public MinecraftIllusionerEntity thisMage;

	@Override
	public void render(MinecraftIllusionerEntity entity, float entityYaw, float partialTicks, MatrixStack stack,
