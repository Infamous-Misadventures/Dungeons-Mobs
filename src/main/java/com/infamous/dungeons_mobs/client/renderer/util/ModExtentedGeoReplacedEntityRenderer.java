...
public abstract class ModExtentedGeoReplacedEntityRenderer<T extends IAnimatable>
	...
	public ModExtentedGeoReplacedEntityRenderer(EntityRendererProvider.Context renderManager,
	...
	protected ModExtentedGeoReplacedEntityRenderer(EntityRendererProvider.Context renderManager,
			AnimatedGeoModel<IAnimatable> modelProvider, T animation, float widthScale, float heightScale,
			float shadowSize) {
	...
	public void renderEarly(Object animatable, PoseStack stackIn, float partialTicks,
		...
		super.renderEarly(animatable, stackIn, partialTicks, renderTypeBuffer, vertexBuilder, packedLightIn,
	...
	@Override
	public void renderLate(Object animatable, PoseStack stackIn, float partialTicks, MultiBufferSource renderTypeBuffer,
			VertexConsumer bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue,
			float alpha) {
		super.renderLate(animatable, stackIn, partialTicks, renderTypeBuffer, bufferIn, packedLightIn, packedOverlayIn,
							...
							if (!cubeList.isEmpty()) {
								...
								VertexConsumer ivb = ItemRenderer.getArmorFoilBuffer(rtb,
										RenderType.armorCutoutNoCull(
												GeoArmorRenderer.getRenderer(armorItem.getClass(), this.currentEntity)
	...
	public void renderRecursively(GeoBone bone, PoseStack stack, VertexConsumer bufferIn, int packedLightIn,
		...
		ResourceLocation tfb = this
				.getCurrentModelRenderCycle() != software.bernie.geckolib3.util.EModelRenderCycle.INITIAL ? null
		...
		if (customTextureMarker) {
			...
			if (this.rtb != null) {
				RenderType rt = this.getRenderTypeForBone(bone, (T) this.currentAnimatable, this.currentPartialTicks,
	...
	protected void handleItemAndBlockBoneRendering(PoseStack stack, GeoBone bone,
			@javax.annotation.Nullable ItemStack boneItem, @javax.annotation.Nullable BlockState boneBlock,
	...
	protected void renderItemStack(PoseStack stack, MultiBufferSource rtb, int packedLightIn, ItemStack boneItem,
		...
		Minecraft.getInstance().getItemRenderer().renderStatic(currentEntity, boneItem,
				...
				LivingEntityRenderer.getOverlayCoords(currentEntity, 0.0F), currentEntity.getId());
	}
	...
	protected abstract ItemTransforms.TransformType getCameraTransformForItemAtBone(ItemStack boneItem,
			String boneName);
