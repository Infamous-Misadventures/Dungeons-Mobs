...
public class WhispererRenderer extends ExtendedGeoEntityRenderer<WhispererEntity> {
	...
	public WhispererRenderer(EntityRendererProvider.Context renderManager) {
		...
		this.addLayer(new GeoEyeLayer(this,
				new ResourceLocation(DungeonsMobs.MODID, "textures/entity/jungle/whisperer_glow.png")));
	}
	...
	@Override
	protected void preRenderItem(PoseStack stack, ItemStack item, String boneName, WhispererEntity currentEntity,
			IBone bone) {
	...
	@Override
	protected void postRenderItem(PoseStack matrixStack, ItemStack item, String boneName, WhispererEntity currentEntity,
			IBone bone) {
