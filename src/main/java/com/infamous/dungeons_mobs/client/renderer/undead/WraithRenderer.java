...
public class WraithRenderer extends ExtendedGeoEntityRenderer<WraithEntity> {
    ...
    @Override
    protected void applyRotations(WraithEntity entityLiving, MatrixStack matrixStackIn, float ageInTicks,
	...
	@Override
	protected void preRenderItem(MatrixStack stack, ItemStack item, String boneName, WraithEntity currentEntity, IBone bone) {
	...
	@Override
	protected void postRenderItem(MatrixStack matrixStack, ItemStack item, String boneName, WraithEntity currentEntity, IBone bone) {
    ...
    @Override
    protected EquipmentSlotType getEquipmentSlotForArmorBone(String boneName, WraithEntity currentEntity) {
        switch (boneName) {
            case "armorBipedLeftFoot":
            case "armorBipedRightFoot":
