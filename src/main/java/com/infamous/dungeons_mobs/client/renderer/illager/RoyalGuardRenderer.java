...
public class RoyalGuardRenderer extends GeoEntityRenderer<RoyalGuardEntity> {
	...
	public RoyalGuardEntity thisMage;

	@Override
	public void render(RoyalGuardEntity entity, float entityYaw, float partialTicks, MatrixStack stack,
	...
	public void renderRecursively(GeoBone bone, MatrixStack stack, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
		bufferIn = rtb.getBuffer(RenderType.entityTranslucent(
				new ResourceLocation(DungeonsMobs.MODID, "textures/geo_entity/illager/royal_guard.png")));
		...
		if (bone.getName().equals("armourHead")) { // rArmRuff is the name of the bone you to set the item to attach too. Please see Note
			...
			if (this.getArmorResource(thisMage, thisMage.getItemBySlot(EquipmentSlotType.HEAD), EquipmentSlotType.HEAD, null) != null && thisMage.getItemBySlot(EquipmentSlotType.HEAD).getItem() != ForgeRegistries.ITEMS.getValue(new ResourceLocation("dungeons_gear", "royal_guard_helmet"))) {
		...
		if (bone.getName().equals("armourLeftArm")) { // rArmRuff is the name of the bone you to set the item to attach too. Please see Note
			...
			if (this.getArmorResource(thisMage, thisMage.getItemBySlot(EquipmentSlotType.CHEST), EquipmentSlotType.CHEST, null) != null &&
					thisMage.getItemBySlot(EquipmentSlotType.CHEST).getItem() != ForgeRegistries.ITEMS.getValue(new ResourceLocation("dungeons_gear", "royal_guard_chestplate"))) {
	...
	public Integer getUniqueID(RoyalGuardEntity animatable) {
