...
public class IllagerBipedArmorLayer<T extends AbstractIllager, M extends IllagerBipedModel<T>, A extends HumanoidModel<T>>
	...
	public IllagerBipedArmorLayer(RenderLayerParent<T, M> p_i50936_1_, A p_i50936_2_, A p_i50936_3_,
			IllagerBipedModel<T> crossedArmsArmorModel) {
	...
	public void render(PoseStack p_225628_1_, MultiBufferSource p_225628_2_, int p_225628_3_, T p_225628_4_,
		...
		this.renderArmorPiece(p_225628_1_, p_225628_2_, p_225628_4_, EquipmentSlot.CHEST, p_225628_3_,
				crossedArmsArmorModel);
	}

	private void renderArmorPiece(PoseStack p_241739_1_, MultiBufferSource p_241739_2_, T p_241739_3_,
			EquipmentSlot p_241739_4_, int p_241739_5_, IllagerBipedModel<T> crossedArmsModel) {
		...
		if (itemstack.getItem() instanceof ArmorItem) {
			...
			if (armoritem.getSlot() == p_241739_4_) {
				...
				if (armoritem instanceof net.minecraft.world.item.DyeableLeatherItem) {
					...
					this.renderModel(p_241739_1_, p_241739_2_, p_241739_5_, flag1, crossedArmsModel, f, f1, f2,
							crossedTexture);
					this.renderModel(p_241739_1_, p_241739_2_, p_241739_5_, flag1, crossedArmsModel, 1.0F, 1.0F, 1.0F,
							this.getArmorResource(p_241739_3_, itemstack, p_241739_4_, "crossed_overlay"));
				} else {
					this.renderModel(p_241739_1_, p_241739_2_, p_241739_5_, flag1, crossedArmsModel, 1.0F, 1.0F, 1.0F,
							crossedTexture);
				}
	...
	private void renderModel(PoseStack p_241738_1_, MultiBufferSource p_241738_2_, int p_241738_3_, boolean p_241738_5_,
			IllagerBipedModel<T> p_241738_6_, float p_241738_8_, float p_241738_9_, float p_241738_10_,
			ResourceLocation armorResource) {
		VertexConsumer ivertexbuilder = ItemRenderer.getArmorFoilBuffer(p_241738_2_,
				RenderType.armorCutoutNoCull(armorResource), false, p_241738_5_);
		p_241738_6_.renderToBuffer(p_241738_1_, ivertexbuilder, p_241738_3_, OverlayTexture.NO_OVERLAY, p_241738_8_,
				p_241738_9_, p_241738_10_, 1.0F);
	}
...
//            }
	...
	private void setPartVisibilityCrossedArms(IllagerBipedModel<T> illagerEntityModel, EquipmentSlot p_188359_2_,
			boolean armsCanBeCrossed) {
