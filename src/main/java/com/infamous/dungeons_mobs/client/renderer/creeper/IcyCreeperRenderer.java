...
public class IcyCreeperRenderer extends MobRenderer<IcyCreeperEntity, CreeperModel<IcyCreeperEntity>> {
	private static final ResourceLocation ICY_CREEPER_TEXTURE = new ResourceLocation(MODID,
			"textures/entity/creeper/icy_creeper.png");
	...
	public IcyCreeperRenderer(EntityRendererProvider.Context p_i46186_1_) {
		...
		this.addLayer(
				new IcyCreeperChargeLayer(this, new CreeperModel<>(p_i46186_1_.bakeLayer(ModelLayers.CREEPER_ARMOR))));
	}
