...
public class ArmoredPillagerRenderer extends GeoEntityRenderer<ArmoredPillagerEntity> {

	private static final Map<String, ResourceLocation> ARMOR_LOCATION_CACHE = Maps.newHashMap();
	public ArmoredPillagerEntity thisMage;
	public ArmoredPillagerRenderer(EntityRendererManager renderManager) {
	...
	protected void applyRotations(ArmoredPillagerEntity entityLiving, MatrixStack matrixStackIn, float ageInTicks,
								  float rotationYaw, float partialTicks) {
		float scaleFactor = entityLiving.isDiamond() ? 1.0375F : 0.9375F;
		matrixStackIn.scale(scaleFactor, scaleFactor, scaleFactor);
		super.applyRotations(entityLiving, matrixStackIn, ageInTicks, rotationYaw, partialTicks);
	}

	@Override
	public RenderType getRenderType(ArmoredPillagerEntity animatable, float partialTicks, MatrixStack stack,
									IRenderTypeBuffer renderTypeBuffer, IVertexBuilder vertexBuilder, int packedLightIn,
									ResourceLocation textureLocation) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}
	@Override
	public void render(ArmoredPillagerEntity entity, float entityYaw, float partialTicks, MatrixStack stack,
 ...
 */
	...
	public Integer getUniqueID(ArmoredPillagerEntity animatable) {
