...
public class NecromancerRenderer extends ExtendedGeoEntityRenderer<NecromancerEntity> {
	...
	public NecromancerRenderer(EntityRendererProvider.Context renderManager) {
		...
		this.addLayer(new PulsatingGlowLayer(this,
				new ResourceLocation(DungeonsMobs.MODID, "textures/entity/skeleton/necromancer_eyes.png"), 0.2F, 1.0F,
				0.5F));
	}
	...
	@Override
	protected void preRenderItem(PoseStack stack, ItemStack item, String boneName, NecromancerEntity currentEntity,
			IBone bone) {
	...
	protected void postRenderItem(PoseStack matrixStack, ItemStack item, String boneName,
			NecromancerEntity currentEntity, IBone bone) {
