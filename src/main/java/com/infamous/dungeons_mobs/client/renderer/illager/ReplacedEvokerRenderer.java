...
public class ReplacedEvokerRenderer extends ModExtentedGeoReplacedEntityRenderer<ReplacedEvokerEntity> {
    ...
    @Override
    protected void preRenderItem(PoseStack stack, ItemStack item, String boneName, ReplacedEvokerEntity currentEntity, IBone bone) {
    ...
    @Override
    protected void postRenderItem(PoseStack matrixStack, ItemStack item, String boneName, ReplacedEvokerEntity currentEntity, IBone bone) {
