...
public class ReplacedEvokerRenderer extends ModExtentedGeoReplacedEntityRenderer<ReplacedEvokerEntity> {
	...
	public ReplacedEvokerRenderer(EntityRendererProvider.Context renderManager) {
		super(renderManager, new ReplacedEvokerModel(), new ReplacedEvokerEntity());
	}
	...
	@Override
	protected void preRenderItem(PoseStack stack, ItemStack item, String boneName, ReplacedEvokerEntity currentEntity,
			IBone bone) {
	...
	protected void postRenderItem(PoseStack matrixStack, ItemStack item, String boneName,
			ReplacedEvokerEntity currentEntity, IBone bone) {
	...
	@Override
	protected EquipmentSlot getEquipmentSlotForArmorBone(String boneName, ReplacedEvokerEntity currentEntity) {
		switch (boneName) {
		case "armorBipedLeftFoot":
		case "armorBipedRightFoot":
