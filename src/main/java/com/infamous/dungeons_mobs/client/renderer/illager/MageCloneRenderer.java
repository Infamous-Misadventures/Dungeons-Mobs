...
public class MageCloneRenderer extends ExtendedGeoEntityRenderer<MageCloneEntity> {
    ...
    @Nullable
    @Override
    protected ResourceLocation getTextureForBone(String s, MageCloneEntity windcallerEntity) {
        return null;
    }

	@Override
	protected ItemStack getHeldItemForBone(String boneName, MageCloneEntity currentEntity) {
		switch (boneName) {
	...
	@Override
	protected void preRenderItem(MatrixStack stack, ItemStack item, String boneName, MageCloneEntity currentEntity, IBone bone) {
	...
	@Override
	protected void postRenderItem(MatrixStack matrixStack, ItemStack item, String boneName, MageCloneEntity currentEntity, IBone bone) {

	}
    
	@Override
	protected BlockState getHeldBlockForBone(String boneName, MageCloneEntity currentEntity) {
		return null;
	}
	
	@Override
	protected void preRenderBlock(MatrixStack matrixStack, BlockState block, String boneName,
			MageCloneEntity currentEntity) {
    ...
    @Nullable
    @Override
    protected ItemStack getArmorForBone(String boneName, MageCloneEntity currentEntity) {
        switch (boneName) {
    ...
    @Override
    protected EquipmentSlotType getEquipmentSlotForArmorBone(String boneName, MageCloneEntity currentEntity) {
        switch (boneName) {
            case "armorBipedLeftFoot":
            case "armorBipedRightFoot":
