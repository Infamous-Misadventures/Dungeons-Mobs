...
public class MageCloneRenderer extends GeoEntityRenderer<MageCloneEntity> {
	...
	public void renderRecursively(GeoBone bone, MatrixStack stack, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
		bufferIn = rtb.getBuffer(RenderType.entityTranslucent(new ResourceLocation(DungeonsMobs.MODID, "textures/geo_entity/illager/mage.png")));
		...
		if (bone.getName().equals("headWear") &&
				!(thisMage.getItemBySlot(EquipmentSlotType.HEAD).getItem() instanceof ArmorItem)) {
	...
	public Integer getUniqueID(MageCloneEntity animatable) {
