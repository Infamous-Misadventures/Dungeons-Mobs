...
public class ArmoredVindicatorRenderer extends GeoEntityRenderer<ArmoredVindicatorEntity> {
	...
	public ArmoredVindicatorEntity thisMage;
	...
	protected void applyRotations(ArmoredVindicatorEntity entityLiving, MatrixStack matrixStackIn, float ageInTicks,
		...
		float scaleFactor = !(entityLiving.isDiamond()) ? 0.9375F : 1.0585F;
	...
	@Override
	public void render(ArmoredVindicatorEntity entity, float entityYaw, float partialTicks, MatrixStack stack,
	...
	public void renderRecursively(GeoBone bone, MatrixStack stack, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
		bufferIn = rtb.getBuffer(RenderType.entityTranslucent(thisMage.isDiamond() ?
	...
	public Integer getUniqueID(ArmoredVindicatorEntity animatable) {
