...
public class ReplacedPillagerRenderer extends ModExtentedGeoReplacedEntityRenderer<ReplacedPillagerEntity> {
	...
	@Override
	protected void preRenderItem(PoseStack stack, ItemStack item, String boneName, ReplacedPillagerEntity currentEntity,
			IBone bone) {
	...
	protected void postRenderItem(PoseStack matrixStack, ItemStack item, String boneName,
			ReplacedPillagerEntity currentEntity, IBone bone) {
