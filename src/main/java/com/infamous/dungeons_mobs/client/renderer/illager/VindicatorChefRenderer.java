...
import com.infamous.dungeons_mobs.client.models.illager.VindicatorChefModel;
...
public class VindicatorChefRenderer extends GeoEntityRenderer<VindicatorChefEntity> {
	public VindicatorChefRenderer(EntityRendererManager renderManager) {
		super(renderManager, new VindicatorChefModel());
	...
	protected void applyRotations(VindicatorChefEntity entityLiving, MatrixStack matrixStackIn, float ageInTicks,
	...
	@Override
	public RenderType getRenderType(VindicatorChefEntity animatable, float partialTicks, MatrixStack stack,
	...
	public VindicatorChefEntity thisMage;

	@Override
	public void render(VindicatorChefEntity entity, float entityYaw, float partialTicks, MatrixStack stack,
	...
	public void renderRecursively(GeoBone bone, MatrixStack stack, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
		bufferIn = rtb.getBuffer(RenderType.entityTranslucent(
				new ResourceLocation(DungeonsMobs.MODID, "textures/geo_entity/illager/vindicator_chef.png")));
	...
	public Integer getUniqueID(VindicatorChefEntity animatable) {
