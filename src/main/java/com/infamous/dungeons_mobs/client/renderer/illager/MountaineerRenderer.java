...
public class MountaineerRenderer extends ExtendedGeoEntityRenderer<MountaineerEntity> {
    ...
    @Nullable
    @Override
    protected ResourceLocation getTextureForBone(String s, MountaineerEntity windcallerEntity) {
        return null;
    }

	@Override
	protected ItemStack getHeldItemForBone(String boneName, MountaineerEntity currentEntity) {
		switch (boneName) {
	...
	@Override
	protected void preRenderItem(MatrixStack stack, ItemStack item, String boneName, MountaineerEntity currentEntity, IBone bone) {
	...
	@Override
	protected void postRenderItem(MatrixStack matrixStack, ItemStack item, String boneName, MountaineerEntity currentEntity, IBone bone) {

	}
    
	@Override
	protected BlockState getHeldBlockForBone(String boneName, MountaineerEntity currentEntity) {
		return null;
	}
	
	@Override
	protected void preRenderBlock(MatrixStack matrixStack, BlockState block, String boneName,
			MountaineerEntity currentEntity) {
    ...
    @Nullable
    @Override
    protected ItemStack getArmorForBone(String boneName, MountaineerEntity currentEntity) {
        switch (boneName) {
    ...
    @Override
    protected EquipmentSlotType getEquipmentSlotForArmorBone(String boneName, MountaineerEntity currentEntity) {
        switch (boneName) {
            case "armorBipedLeftFoot":
            case "armorBipedRightFoot":
