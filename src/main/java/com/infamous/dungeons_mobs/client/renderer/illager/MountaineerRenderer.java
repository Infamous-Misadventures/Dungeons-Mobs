...
public class MountaineerRenderer extends GeoEntityRenderer<MountaineerEntity> {
	...
	public MountaineerEntity thisMage;
	...
	@Override
	public void render(MountaineerEntity entity, float entityYaw, float partialTicks, MatrixStack stack,
	...
	public void renderRecursively(GeoBone bone, MatrixStack stack, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
		...
		bufferIn = rtb.getBuffer(RenderType.entityTranslucent(new ResourceLocation(DungeonsMobs.MODID, "textures/geo_entity/illager/mountaineer.png")));
 ...
 */
	...
	public Integer getUniqueID(MountaineerEntity animatable) {
