...
public class MountaineerRenderer extends MobRenderer<MountaineerEntity, IllagerBipedModel<MountaineerEntity>> {
    ...
    public MountaineerRenderer(EntityRendererManager renderManagerIn) {
        ...
        this.addLayer(new HeldItemLayer<MountaineerEntity, IllagerBipedModel<MountaineerEntity>>(this) {
            public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, MountaineerEntity vindicatorEntity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    protected void scale(MountaineerEntity vindicatorEntity, MatrixStack matrixStack, float v) {
