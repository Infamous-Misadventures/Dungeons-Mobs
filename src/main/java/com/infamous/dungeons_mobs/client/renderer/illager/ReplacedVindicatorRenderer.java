...
public class ReplacedVindicatorRenderer extends ModExtentedGeoReplacedEntityRenderer<ReplacedVindicatorEntity> {
    ...
    @Override
    protected void preRenderItem(PoseStack stack, ItemStack item, String boneName, ReplacedVindicatorEntity currentEntity, IBone bone) {
    ...
    @Override
    protected void postRenderItem(PoseStack matrixStack, ItemStack item, String boneName, ReplacedVindicatorEntity currentEntity, IBone bone) {
    ...
    @Override
    protected EquipmentSlot getEquipmentSlotForArmorBone(String boneName, ReplacedVindicatorEntity currentEntity) {
        switch (boneName) {
            case "armorBipedLeftFoot":
            case "armorBipedRightFoot":
