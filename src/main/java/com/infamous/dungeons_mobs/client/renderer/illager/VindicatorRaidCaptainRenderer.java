...
import com.infamous.dungeons_mobs.entities.illagers.minibosses.RampartCaptainEntity;
...
public class VindicatorRaidCaptainRenderer extends GeoEntityRenderer<VindicatorRaidCaptainEntity> {
	public VindicatorRaidCaptainRenderer(EntityRendererManager renderManager) {
		super(renderManager, new VindicatorRaidCaptainModel());
	...
	protected void applyRotations(VindicatorRaidCaptainEntity entityLiving, MatrixStack matrixStackIn, float ageInTicks,
								  float rotationYaw, float partialTicks) {
		float scaleFactor = 1.1025F;
		matrixStackIn.scale(scaleFactor, scaleFactor, scaleFactor);
		super.applyRotations(entityLiving, matrixStackIn, ageInTicks, rotationYaw, partialTicks);
	}

	@Override
	public RenderType getRenderType(VindicatorRaidCaptainEntity animatable, float partialTicks, MatrixStack stack,
	...
	public VindicatorRaidCaptainEntity thisMage;

	@Override
	public void render(VindicatorRaidCaptainEntity entity, float entityYaw, float partialTicks, MatrixStack stack,
	...
	public void renderRecursively(GeoBone bone, MatrixStack stack, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
		bufferIn = rtb.getBuffer(RenderType.entityTranslucent(
				new ResourceLocation(DungeonsMobs.MODID, "textures/geo_entity/illager/diamond_armored_vindicator_leader.png")));
	...
	public Integer getUniqueID(VindicatorRaidCaptainEntity animatable) {
