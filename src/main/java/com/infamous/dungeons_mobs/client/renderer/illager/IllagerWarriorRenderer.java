...
public class IllagerWarriorRenderer extends GeoEntityRenderer<IllagerWarriorEntity> {
	public IllagerWarriorRenderer(EntityRendererManager renderManager) {
	...
	protected void applyRotations(IllagerWarriorEntity entityLiving, MatrixStack matrixStackIn, float ageInTicks,
	...
	@Override
	public RenderType getRenderType(IllagerWarriorEntity animatable, float partialTicks, MatrixStack stack,
