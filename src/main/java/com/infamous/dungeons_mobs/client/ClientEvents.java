...
////        }
		...
		event.registerEntityRenderer(ModEntityTypes.ROYAL_GUARD.get(),
				manager -> new DefaultIllagerRenderer<>(manager, new RoyalGuardModel(), 0.9375F * 1.2F));
		event.registerEntityRenderer(ModEntityTypes.MOUNTAINEER.get(),
				manager -> new DefaultIllagerRenderer<>(manager, new MountaineerModel()));

		event.registerEntityRenderer(ModEntityTypes.ICEOLOGER.get(),
				manager -> new DefaultIllagerRenderer<>(manager, new IceologerModel()));
		event.registerEntityRenderer(ModEntityTypes.GEOMANCER.get(),
				manager -> new DefaultIllagerRenderer<>(manager, new GeomancerModel()));

		event.registerEntityRenderer(ModEntityTypes.MAGE.get(),
				manager -> new DefaultIllagerRenderer<MageEntity>(manager, new MageModel()));
		event.registerEntityRenderer(ModEntityTypes.MAGE_CLONE.get(),
				manager -> new DefaultIllagerRenderer<MageCloneEntity>(manager, new MageModel()));

		event.registerEntityRenderer(ModEntityTypes.ILLUSIONER.get(), DungeonsIllusionerRenderer::new);
		event.registerEntityRenderer(ModEntityTypes.ILLUSIONER_CLONE.get(),
				manager -> new DefaultIllagerRenderer<IllusionerCloneEntity>(manager, new DungeonsIllusionerModel()));
		event.registerEntityRenderer(ModEntityTypes.WINDCALLER.get(),
...
//        event.registerEntityRenderer(ModEntityTypes.ENCHANTER.get(), EnchanterRenderer::new);
		...
		event.registerEntityRenderer(EntityType.PIGLIN, manager -> new CustomPiglinRenderer(manager, ModelLayers.PIGLIN,
				ModelLayers.PIGLIN_INNER_ARMOR, ModelLayers.PIGLIN_OUTER_ARMOR, false, false));
		event.registerEntityRenderer(ModEntityTypes.FUNGUS_THROWER.get(), manager -> new CustomPiglinRenderer(manager,
				ModelLayers.PIGLIN, ModelLayers.PIGLIN_INNER_ARMOR, ModelLayers.PIGLIN_OUTER_ARMOR, false, true));
		event.registerEntityRenderer(EntityType.ZOMBIFIED_PIGLIN,
				manager -> new CustomPiglinRenderer(manager, ModelLayers.ZOMBIFIED_PIGLIN,
						ModelLayers.ZOMBIFIED_PIGLIN_INNER_ARMOR, ModelLayers.ZOMBIFIED_PIGLIN_OUTER_ARMOR, true,
						false));
		event.registerEntityRenderer(ModEntityTypes.ZOMBIFIED_FUNGUS_THROWER.get(),
				manager -> new CustomPiglinRenderer(manager, ModelLayers.ZOMBIFIED_PIGLIN,
						ModelLayers.ZOMBIFIED_PIGLIN_INNER_ARMOR, ModelLayers.ZOMBIFIED_PIGLIN_OUTER_ARMOR, true,
						true));
		...
		GeoArmorRenderer.registerArmorRenderer(DrownedNecromancerArmorGear.class,
				DrownedNecromancerArmorGearRenderer::new);
	}
	...
	public static void onParticleFactory(RegisterParticleProvidersEvent event) {
		...
		Minecraft.getInstance().particleEngine.register(ModParticleTypes.REDSTONE_SPARK.get(),
				RedstoneSparkParticle.Factory::new);
		...
		Minecraft.getInstance().particleEngine.register(ModParticleTypes.NECROMANCY.get(),
				NecromancyParticle.Factory::new);
