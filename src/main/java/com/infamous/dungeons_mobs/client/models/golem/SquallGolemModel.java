...
public class SquallGolemModel<T extends SquallGolemEntity> extends SegmentedModel<T> {
	...
	public SquallGolemModel() {
		...
		rightArm.setTextureOffset(0, 117).addBox(-4.0F, 5.25F + 13.75F, 0.5F, 6.0F, 4.0F, 7.0F, 0.0F, false);
		...
		leftArm.setTextureOffset(0, 117).addBox(-3.0F, 5.25F + 13.75F, 0.5F, 6.0F, 4.0F, 7.0F, 0.0F, false);
