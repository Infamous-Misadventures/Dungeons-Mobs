...
public class SmartSkeletonModel<T extends AbstractSkeleton> extends SkeletonModel<T> {
	...
	@Override
	public void setupAnim(T skeleton, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_,
			float p_225597_6_) {
		super.setupAnim(skeleton, p_225597_2_, p_225597_3_, p_225597_4_, p_225597_5_, p_225597_6_);
		if (this.swimAmount > 0.0F) {
			this.rightArm.xRot = this.rotlerpRad(this.swimAmount, this.rightArm.xRot, -2.5132742F)
					+ this.swimAmount * 0.35F * Mth.sin(0.1F * p_225597_4_);
			this.leftArm.xRot = this.rotlerpRad(this.swimAmount, this.leftArm.xRot, -2.5132742F)
					- this.swimAmount * 0.35F * Mth.sin(0.1F * p_225597_4_);
