...
public class FungusSackModel<T extends LivingEntity> extends AgeableListModel<T> {
	...
	public static LayerDefinition createBackpackLayer() {
		...
		partdefinition.addOrReplaceChild("backpack",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -4.1111F, -0.0556F, 8.0F, 9.0F, 7.0F),
				PartPose.ZERO);
		return LayerDefinition.create(meshdefinition, 32, 16);
	}

	@Override
	public void setupAnim(T wearer, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_,
			float p_225597_6_) {
		this.root.y = 4.3611F;
