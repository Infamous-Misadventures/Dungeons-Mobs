...
public class VindicatorHelmetModel<T extends LivingEntity> extends HumanoidModel<T> {
	...
	public static LayerDefinition createHelmetLayer() {
		...
		PartDefinition helmet = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 0).addBox(-5.0F, -35.0F + 25.0F, -5.0F, 10.0F, 10.0F, 10.0F),
				PartPose.offset(0.0F, 24.0F, 0.0F));
		helmet.addOrReplaceChild("horn1",
				CubeListBuilder.create().texOffs(46, 27).addBox(5.0F, -34.5F, -6.0F, 2.0F, 2.0F, 4.0F),
				PartPose.offsetAndRotation(0.0F, 16.0F, -23.0F, -0.7854F, 0.0F, 0.0F));
		helmet.addOrReplaceChild("horn2",
				CubeListBuilder.create().texOffs(46, 27).addBox(-7.0F, -34.5F, -6.0F, 2.0F, 2.0F, 4.0F),
				PartPose.offsetAndRotation(-1.0F, 0.0F, -4.0F, -0.7854F, 0.0F, 0.0F));
