...
public class PowerfulRoyalGuardModel extends AnimatedGeoModel {
		...
		public ResourceLocation getModelLocation(Object entity) {
			return (entity instanceof PowerfulRoyalGuardEntity && ((PowerfulRoyalGuardEntity)entity).isDiamond()) ?
					new ResourceLocation(DungeonsMobs.MODID, "geo/diamond_royal_guard.geo.json"):
					new ResourceLocation(DungeonsMobs.MODID, "geo/gold_royal_guard.geo.json");
		}

		@Override
		public ResourceLocation getTextureLocation(Object entity) {
			return (entity instanceof PowerfulRoyalGuardEntity && ((PowerfulRoyalGuardEntity)entity).isDiamond()) ?
					new ResourceLocation(DungeonsMobs.MODID, "textures/entity/illager/diamond_royal_guard.png"):
					new ResourceLocation(DungeonsMobs.MODID, "textures/entity/illager/gold_royal_guard.png");
		}
