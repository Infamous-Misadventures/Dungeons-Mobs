...
public class RoyalGuardModel extends AnimatedGeoModel {
		...
		public ResourceLocation getTextureLocation(Object entity) {
			return new ResourceLocation(DungeonsMobs.MODID, "textures/geo_entity/illager/royal_guard.png");
		}
	...
	public void setLivingAnimations(IAnimatable entity, Integer uniqueID, AnimationEvent customPredicate) {
		...
		IBone r = this.getAnimationProcessor().getBone("royalguard2");
		IBone rr = this.getAnimationProcessor().getBone("royalguard");
		...
		if (((RoyalGuardEntity)entityIn).getItemBySlot(EquipmentSlotType.HEAD).getItem() != ForgeRegistries.ITEMS.getValue(new ResourceLocation("dungeons_gear", "royal_guard_helmet"))) {
			r.setScaleX(0);
			r.setScaleY(0);
			r.setScaleZ(0);
		}else {
		...
		if (((RoyalGuardEntity)entityIn).getItemBySlot(EquipmentSlotType.CHEST).getItem() != ForgeRegistries.ITEMS.getValue(new ResourceLocation("dungeons_gear", "royal_guard_chestplate"))) {
			rr.setScaleX(0);
			rr.setScaleY(0);
			rr.setScaleZ(0);
		}else {
