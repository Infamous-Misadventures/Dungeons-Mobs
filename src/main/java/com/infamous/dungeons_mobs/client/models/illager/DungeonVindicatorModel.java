...
public class DungeonVindicatorModel extends AnimatedGeoModel {
		...
		public ResourceLocation getTextureLocation(Object entity) {
			return new ResourceLocation(DungeonsMobs.MODID, "textures/geo_entity/illager/vindicator.png");
		}
	...
	public void setLivingAnimations(IAnimatable entity, Integer uniqueID, AnimationEvent customPredicate) {
		...
		if (extraData.headPitch != 0 || extraData.netHeadYaw != 0) {
			((DungeonsVindicatorEntity)entityIn).setH(true);
			if (!((DungeonsVindicatorEntity)entityIn).getG()) {
			...
			((DungeonsVindicatorEntity)entityIn).setH(false);
	}
