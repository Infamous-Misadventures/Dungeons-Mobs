...
import com.infamous.dungeons_mobs.entities.illagers.minibosses.PillagerRaidCaptainEntity;
...
public class DungeonPillagerModel extends AnimatedGeoModel {

		@Override
		public ResourceLocation getAnimationFileLocation(Object entity) {
			return new ResourceLocation(DungeonsMobs.MODID, "animations/pillager_geo.animation.json");
		}
		...
		public ResourceLocation getTextureLocation(Object entity) {
			return new ResourceLocation(DungeonsMobs.MODID,
					entity instanceof ArmoredPillagerEntity ?
							((ArmoredPillagerEntity)entity).isDiamond() ?
									"textures/geo_entity/illager/diamond_armored_pillager.png" :
									"textures/geo_entity/illager/gold_armored_pillager.png" :
							entity instanceof PillagerRaidCaptainEntity ?
									"textures/geo_entity/illager/diamond_armored_pillager_leader.png" :
									"textures/geo_entity/illager/pillager.png"
			);
		}
	...
	public void setLivingAnimations(IAnimatable entity, Integer uniqueID, AnimationEvent customPredicate) {
		...
		if (extraData.headPitch != 0 || extraData.netHeadYaw != 0) {
			...
			{
				float j = Math.max(extraData.headPitch, -extraData.headPitch);
				float e = extraData.netHeadYaw;
				rh.setRotationX(rh.getRotationX() + ((extraData.headPitch * ((float) Math.PI / 180F))) / 3.14F);
				rh.setRotationY(rh.getRotationY() + ((extraData.netHeadYaw * ((float) Math.PI / 180F))) / 3.14F);
				lh.setRotationX(rh.getRotationX() + ((extraData.headPitch * ((float) Math.PI / 180F))) / 3.14F);
				lh.setRotationY(rh.getRotationY() + ((extraData.netHeadYaw * ((float) Math.PI / 180F))) / 3.14F);
			}
		}
	}
