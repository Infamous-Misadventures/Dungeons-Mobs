...
public class VindicatorRaidCaptainModel extends AnimatedGeoModel {
		...
		public ResourceLocation getModelLocation(Object entity) {
			return new ResourceLocation(DungeonsMobs.MODID, "geo/diamond_vindicator_leader.geo.json") ;
		}

		@Override
		public ResourceLocation getTextureLocation(Object entity) {
			return new ResourceLocation(DungeonsMobs.MODID, "textures/entity/illager/diamond_armored_vindicator_leader.png");
		}
