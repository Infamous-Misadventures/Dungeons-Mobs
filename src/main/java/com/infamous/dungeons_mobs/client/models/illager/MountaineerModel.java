...
public class MountaineerModel extends AnimatedGeoModel {
		...
		public ResourceLocation getTextureLocation(Object entity) {
			return new ResourceLocation(DungeonsMobs.MODID, "textures/geo_entity/illager/mountaineer.png");
		}
	...
	public void setLivingAnimations(IAnimatable entity, Integer uniqueID, AnimationEvent customPredicate) {
		...
		if (extraData.headPitch != 0 || extraData.netHeadYaw != 0) {
			((MountaineerEntity)entityIn).setH(true);
			if (!((MountaineerEntity)entityIn).getG()) {
			...
			((MountaineerEntity)entityIn).setH(false);
	}
