...
public class MagicAttackGoal<T extends Monster & IMagicUser> extends Goal {
	...
	public boolean canContinueToUse() {
		return ((this.canUse() || !this.magicUserMob.getNavigation().isDone()) && !this.magicUserMob.isUsingMagic());
	}
	...
	public void tick() {
		...
		if (livingentity != null) {
			double squareDistanceToTarget = this.magicUserMob.distanceToSqr(livingentity.getX(), livingentity.getY(),
					livingentity.getZ());
