...
public class SmartTridentAttackGoal extends RangedAttackGoal {
	...
	public SmartTridentAttackGoal(RangedAttackMob rangedAttackMob, double speedModifier, int attackInterval,
			float attackRadius) {
	...
	public void start() {
		...
		this.thrower
				.startUsingItem(ProjectileUtil.getWeaponHoldingHand(this.thrower, item -> item instanceof TridentItem));
	}
