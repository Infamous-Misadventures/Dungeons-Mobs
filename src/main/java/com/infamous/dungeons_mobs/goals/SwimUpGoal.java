...
public class SwimUpGoal<T extends PathfinderMob & IAquaticMob> extends Goal {
	...
	public boolean canUse() {
		return !this.aquaticMob.level.isDay() && this.aquaticMob.isInWater()
				&& this.aquaticMob.getY() < (double) (this.seaLevel - 2);
	}
	...
	public void tick() {
		if (this.aquaticMob.getY() < (double) (this.seaLevel - 1)
				&& (this.aquaticMob.getNavigation().isDone() || this.aquaticMob.closeToNextPos(this.aquaticMob))) {
			Vec3 vector3d = DefaultRandomPos.getPosTowards(this.aquaticMob, 4, 8,
					new Vec3(this.aquaticMob.getX(), (double) (this.seaLevel - 1), this.aquaticMob.getZ()),
