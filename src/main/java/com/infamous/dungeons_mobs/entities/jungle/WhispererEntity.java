...
public class WhispererEntity extends MonsterEntity implements IMagicUser, IAnimatable {
    ...
    class MeleeGoal extends Goal {
        ...
        public WhispererEntity v = WhispererEntity.this;
        ...
        @Override
        public boolean canUse() {
            return v.getTarget() != null && v.entityData.get(C_MELEE);
        }

        @Override
        public boolean canContinueToUse() {
            //animation tick
            return v.entityData.get(TIMER) < 21 && (v.getTarget() != null && v.getTarget().isAlive());
        }
        ...
        public void stop() {
            ...
            v.entityData.set(C_MELEE, false);
            if (v.getTarget() == null) {
        ...
        public void tick() {
            ...
            if (v.getTarget() != null && v.getTarget().isAlive()) {
                ...
                if (v.entityData.get(TIMER) == 12 && v.distanceToSqr(v.getTarget()) <= 6.0D+ v.getTarget().getBbWidth()) {
