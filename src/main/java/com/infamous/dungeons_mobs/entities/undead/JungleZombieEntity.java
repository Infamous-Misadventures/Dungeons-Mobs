...
public class JungleZombieEntity extends ZombieEntity{
    ...
    public static boolean canJungleZombieSpawn(EntityType<JungleZombieEntity> entityType, IWorld iWorld, SpawnReason spawnReason, BlockPos blockPos, Random rand) {
