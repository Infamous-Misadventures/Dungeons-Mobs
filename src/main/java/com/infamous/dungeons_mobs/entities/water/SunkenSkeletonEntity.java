...
public class SunkenSkeletonEntity extends AbstractSkeleton implements CrossbowAttackMob, IAquaticMob {
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(1,
				(new HurtByTargetGoal(this, SunkenSkeletonEntity.class)).setAlertOthers(SunkenSkeletonEntity.class));
	...
	public void reassessWeaponGoal() {
		if (this.isConstructed && this.level != null && !this.level.isClientSide) {
			...
			ItemStack bowStack = this
					.getItemInHand(ProjectileUtil.getWeaponHoldingHand(this, item -> item instanceof BowItem));
			ItemStack crossbowStack = this
					.getItemInHand(ProjectileUtil.getWeaponHoldingHand(this, item -> item instanceof CrossbowItem));
	...
	@Override
	public void shootCrossbowProjectile(LivingEntity p_234279_1_, LivingEntity p_234279_2_, Projectile p_234279_3_,
		...
		p_234279_1_.playSound(
				this.isInWater() ? ModSoundEvents.SUNKEN_SKELETON_SHOOT.get() : SoundEvents.CROSSBOW_SHOOT, 1.0F,
