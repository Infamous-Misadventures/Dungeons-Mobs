...
public class RedstoneCubeEntity extends Monster {
	...
	private static final EntityDataAccessor<Boolean> IS_ROLLING = SynchedEntityData.defineId(RedstoneCubeEntity.class,
	...
	public static AttributeSupplier.Builder setCustomAttributes() {
		return Monster.createMonsterAttributes().add(Attributes.MAX_HEALTH, 4.0D * 4.0D)
	...
	protected void dealDamage(LivingEntity entityIn) {
		if (this.isAlive()) {
			...
			if (this.distanceToSqr(entityIn) < 0.6D * (double) i * 0.6D * (double) i && this.hasLineOfSight(entityIn)
					&& entityIn.hurt(DamageSource.mobAttack(this), this.getAttackDamageAmount())) {
	...
	static class AttackGoal extends Goal {
		...
		public void tick() {
			...
			((RedstoneCubeEntity.MoveHelperController) this.redstoneCubeEntity.getMoveControl())
					.setDirection(this.redstoneCubeEntity.getYRot(), this.redstoneCubeEntity.canDamagePlayer());
	...
	static class FaceRandomGoal extends Goal {
		 ...
		 */
		public boolean canUse() {
			return this.redstoneCubeEntity.getTarget() == null && (this.redstoneCubeEntity.isOnGround()
	...
	public void aiStep() {
		...
		if (this.isRolling()) {
			if (this.level.isClientSide) {
				this.level.addParticle(DustParticleOptions.REDSTONE, this.getRandomX(0.5D) + 1.0D,
						this.getRandomY() - 0.25D + 1.0D, this.getRandomZ(0.5D) + 1.0D,
