...
import software.bernie.geckolib3.core.controller.AnimationController;package com.infamous.dungeons_mobs.entities.redstone;
...
public class RedstoneGolemEntity extends AbstractRaiderEntity implements IAnimatable {
    ...
    public void aiStep() {
        ...
        if (!this.level.isClientSide && this.mineAttackCooldown > 30 && this.getTarget() != null && this.getTarget().isAlive()) {
    ...
    class AttackGoal extends MeleeAttackGoal {
        ...
        public void tick() {
            ...
            if (--this.delayCounter <= 0) {
                this.delayCounter = 2 + RedstoneGolemEntity.this.getRandom().nextInt(3);
    ...
    class MeleeGoal extends Goal {
        ...
        public void tick() {
            if (v.getTarget() != null && v.getTarget().isAlive()) {
                ...
                if(attackTimer == 8) {
                    v.playSound(ModSoundEvents.REDSTONE_GOLEM_ATTACK.get(),1,1);
                }
    ...
    class SummonRedstoneMinesGoal extends Goal{
        ...
        public SummonRedstoneMinesGoal() {
            this.setFlags(EnumSet.of(Flag.LOOK, Flag.MOVE));
        }
