...
public class SteamProjectileEntity extends AbstractFireballEntity {

    public SteamProjectileEntity(World worldIn){
    ...
    public SteamProjectileEntity(World worldIn, LivingEntity shooter, double accelX, double accelY, double accelZ) {
        super(ModEntityTypes.WRAITH_FIREBALL.get(), shooter, accelX, accelY, accelZ, worldIn);
    }

    public SteamProjectileEntity(World worldIn, double x, double y, double z, double accelX, double accelY, double accelZ) {
