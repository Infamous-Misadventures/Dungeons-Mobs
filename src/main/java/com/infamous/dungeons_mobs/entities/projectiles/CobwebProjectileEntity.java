...
public class CobwebProjectileEntity extends Projectile implements IAnimatable {
	...
	@OnlyIn(Dist.CLIENT)
	public CobwebProjectileEntity(Level p_i47274_1_, double p_i47274_2_, double p_i47274_4_, double p_i47274_6_,
		...
		if (p_213868_1_.getEntity() instanceof LivingEntity
			...
			if (entity instanceof LivingEntity) {
				p_213868_1_.getEntity()
						.hurt(DamageSource.indirectMobAttack(this, (LivingEntity) entity).setProjectile(), 1.0F);
			}
