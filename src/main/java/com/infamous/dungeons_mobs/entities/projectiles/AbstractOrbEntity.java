...
public abstract class AbstractOrbEntity extends Fireball {
	...
	protected AbstractOrbEntity(EntityType<? extends AbstractOrbEntity> entityType, Level worldIn, LivingEntity shooter,
			double accelX, double accelY, double accelZ) {
		super(entityType, shooter, accelX, accelY, accelZ, worldIn);
	}

	protected AbstractOrbEntity(EntityType<? extends AbstractOrbEntity> entityType, Level worldIn, double x, double y,
