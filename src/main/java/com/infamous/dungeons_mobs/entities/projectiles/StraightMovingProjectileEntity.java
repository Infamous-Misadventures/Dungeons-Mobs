...
public abstract class StraightMovingProjectileEntity extends Projectile {
	...
	protected StraightMovingProjectileEntity(EntityType<? extends StraightMovingProjectileEntity> p_i50173_1_,
			Level p_i50173_2_) {
		super(p_i50173_1_, p_i50173_2_);
	}

	public StraightMovingProjectileEntity(EntityType<? extends StraightMovingProjectileEntity> p_i50174_1_,
			double p_i50174_2_, double p_i50174_4_, double p_i50174_6_, double p_i50174_8_, double p_i50174_10_,
			double p_i50174_12_, Level p_i50174_14_) {
		...
		double d0 = (double) Mth
				.sqrt((float) (p_i50174_8_ * p_i50174_8_ + p_i50174_10_ * p_i50174_10_ + p_i50174_12_ * p_i50174_12_));
		if (d0 != 0.0D) {
	...
	public StraightMovingProjectileEntity(EntityType<? extends StraightMovingProjectileEntity> p_i50175_1_,
			LivingEntity p_i50175_2_, double p_i50175_3_, double p_i50175_5_, double p_i50175_7_, Level p_i50175_9_) {
		this(p_i50175_1_, p_i50175_2_.getX(), p_i50175_2_.getY(), p_i50175_2_.getZ(), p_i50175_3_, p_i50175_5_,
				p_i50175_7_, p_i50175_9_);
	...
	public void spawnTrailParticle() {
		this.level.addParticle(this.getTrailParticle(), this.getX(), this.getY() + this.getSpawnParticlesY(),
				this.getZ(), 0, 0, 0);
	}

	public void spawnUnderWaterTrailParticle() {
		this.level.addParticle(this.getUnderWaterTrailParticle(), this.getX(), this.getY() + this.getSpawnParticlesY(),
				this.getZ(), 0, 0, 0);
	}
	...
	protected boolean canHitEntity(Entity p_230298_1_) {
		...
		return super.canHitEntity(p_230298_1_)
				&& ((this.keepsHittingAfterStuck() && this.stuckInBlock) || !this.stuckInBlock)
