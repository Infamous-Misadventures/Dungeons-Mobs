...
public class SnarelingEntity extends AbstractEnderlingEntity implements IAnimatable {
	...
	public void baseTick() {
		...
		if (this.getTarget() != null && this.getTarget().isAlive() && this.distanceTo(this.getTarget()) > 5
				&& this.getTarget().hasEffect(ModEffects.ENSNARED.get()) && this.random.nextInt(10) == 0) {
		...
		if (this.getTarget() != null && this.getTarget().isAlive()
				&& !this.getTarget().hasEffect(ModEffects.ENSNARED.get()) && this.hasLineOfSight(this.getTarget())
				&& this.getShootTime() <= 0 && this.random.nextInt(10) == 0) {
	...
	public class AvoidEntityGoal<T extends LivingEntity> extends Goal {
		...
		public AvoidEntityGoal(PathfinderMob p_i48859_1_, Predicate<LivingEntity> p_i48859_3_, float p_i48859_4_,
				double p_i48859_5_, double p_i48859_7_, Predicate<LivingEntity> p_i48859_9_) {
		...
		public AvoidEntityGoal(PathfinderMob p_i48860_1_, float p_i48860_3_, double p_i48860_4_, double p_i48860_6_,
				Predicate<LivingEntity> p_i48860_8_) {
		...
		public boolean canContinueToUse() {
			return SnarelingEntity.this.getTarget() != null && SnarelingEntity.this.getTarget().isAlive()
					&& !SnarelingEntity.this.getTarget().hasEffect(ModEffects.ENSNARED.get()) && !this.pathNav.isDone();
		}
