...
public class ArmoredPillagerEntity extends DungeonsPillagerEntity {
    ...
    public ArmoredPillagerEntity(EntityType<? extends DungeonsPillagerEntity> p_i50189_1_, World p_i50189_2_) {
    ...
    public void applyRaidBuffs(int i, boolean b) {
        ...
        if (applyEnchant) {
            ...
            enchantmentIntegerMap.put(Enchantments.QUICK_CHARGE, Math.min(enchantmentLevel, 4));
            this.addEffect(new EffectInstance(Effects.HEAL, 10, 6, (false), (false)));
