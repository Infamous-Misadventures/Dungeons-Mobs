...
public class MountaineerEntity extends Vindicator implements SpawnArmoredMob, IAnimatable, AnimatableMeleeAttackMob {
	...
	private static final EntityDataAccessor<Byte> DATA_FLAGS_ID = SynchedEntityData.defineId(MountaineerEntity.class,
	...
	public static AttributeSupplier.Builder setCustomAttributes() {
		return Monster.createMonsterAttributes().add(Attributes.MOVEMENT_SPEED, (double) 0.3F)
	...
	private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
		...
		if (this.attackAnimationTick > 0) {
			event.getController()
					.setAnimation(new AnimationBuilder().addAnimation(animation + ".attack" + handSide, LOOP));
