...
public class IllusionerCloneEntity extends SpellcastingIllagerEntity implements IAnimatable,IRangedAttackMob {
	...
	public static final DataParameter<Integer> LIFT_TICKS = EntityDataManager.defineId(IllusionerCloneEntity.class, DataSerializers.INT);
	public static final DataParameter<Integer> DUPLICATE_TICKS = EntityDataManager.defineId(IllusionerCloneEntity.class, DataSerializers.INT);
	public static final DataParameter<Boolean> ANGRY = EntityDataManager.defineId(IllusionerCloneEntity.class, DataSerializers.BOOLEAN);
    ...
    protected void registerGoals() {
		...
		this.goalSelector.addGoal(5, new IllusionerCloneEntity.RkGoal(this,1));
        ...
        this.goalSelector.addGoal(4, new IllusionerCloneEntity.LiftMobGoal());
	...
	class RkGoal extends MeleeAttackGoal {
		...
		public IllusionerCloneEntity.RkGoal setMaxAttackTick(int max) {
    ...
    class LiftMobGoal extends Goal {
		...
		private boolean d;
	      ...
	      public boolean canUse() {
	         return IllusionerCloneEntity.this.getTarget() != null && IllusionerCloneEntity.this.getLiftTicks() == 0 && IllusionerCloneEntity.this.liftInterval == 0 && IllusionerCloneEntity.this.random.nextInt(20) == 0;
	      }
	      
	      public boolean canContinueToUse() {
	    	  	return IllusionerCloneEntity.this.getTarget() != null && IllusionerCloneEntity.this.getLiftTicks() > 0;
	      }
	    ...
	    IllusionerCloneEntity.this.liftInterval = 58;
			this.d =true;
	    IllusionerCloneEntity.this.setLiftTicks(21);
			IllusionerCloneEntity.this.entityData.set(ANGRY,false);
	    }
	    ...
	    public void tick() {
			...
			if (mob.getLiftTicks() == 1 && this.d) {
				IllusionerCloneEntity.this.setLiftTicks(14);
				IllusionerCloneEntity.this.setAngry(true);
				this.d =false;
	    ...
	    public void stop() {
	    super.stop();
			IllusionerCloneEntity.this.setAngry(false);
	    IllusionerCloneEntity.this.setLiftTicks(0);
	    }
