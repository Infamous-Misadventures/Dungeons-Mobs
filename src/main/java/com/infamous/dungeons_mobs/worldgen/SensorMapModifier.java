...
public class SensorMapModifier {
    ...
    public static void replaceSensorMaps(){
        ImmutableMap<EntityType<?>, Float> oldImmutableVillagerHostiles = VillagerHostilesSensor.field_220991_b;
        ...
        VillagerHostilesSensor.field_220991_b = ImmutableMap.copyOf(villagerHostiles);
    }
}
