...
import com.infamous.dungeons_mobs.entities.allcustomentity.illagers.IllagerWarriorCloneEntity;
...
public class ModEntityTypes {
    ...
    public static final RegistryObject<EntityType<PillagerRaidCaptainEntity>> PILLAGER_RAID_CAPRAIN = ENTITY_TYPES.register("pillager_raid_captain", () ->
            EntityType.Builder.<PillagerRaidCaptainEntity>of(PillagerRaidCaptainEntity::new, EntityClassification.MONSTER)
                    .sized(0.6F * 1.1F, 2.1F)
                    .clientTrackingRange(8)
                    .setCustomClientFactory((spawnEntity,world) -> new PillagerRaidCaptainEntity(world))
                    .build(new ResourceLocation(MODID, "pillager_raid_captain").toString())
    );
    ...
    public static final RegistryObject<EntityType<MinecraftIllusionerEntity>> DUNGEONS_ILLUSIONER = ENTITY_TYPES.register("e_illusioner", () ->
            EntityType.Builder.<MinecraftIllusionerEntity>of(MinecraftIllusionerEntity::new, EntityClassification.MONSTER)
                    .sized(0.6F, 1.95F)
                    .clientTrackingRange(8)
                    .build(new ResourceLocation(MODID, "e_illusioner").toString())
    );

    public static final RegistryObject<EntityType<IllusionerCloneCloneEntity>> ILLUSIONER_CLONE_C = ENTITY_TYPES.register("e_illusioner_clone", () ->
            EntityType.Builder.<IllusionerCloneCloneEntity>of(IllusionerCloneCloneEntity::new, EntityClassification.MONSTER)
                    .sized(0.1F, 1.95F)
                    .clientTrackingRange(1)
                    .setCustomClientFactory((spawnEntity,world) -> new IllusionerCloneCloneEntity(world))
                    .build(new ResourceLocation(MODID, "e_illusioner_clone").toString())
    );
    ...
    public static final RegistryObject<EntityType<DungeonsPillagerEntity>> PILLAGER = ENTITY_TYPES.register("pillager", () ->
            EntityType.Builder.<DungeonsPillagerEntity>of(DungeonsPillagerEntity::new, EntityClassification.MONSTER)
                    .sized(0.7F, 1.95F)
                    .clientTrackingRange(8)
                    .setCustomClientFactory((spawnEntity,world) -> new DungeonsPillagerEntity(world))
                    .build(new ResourceLocation(MODID, "pillager").toString())
    );

    public static final RegistryObject<EntityType<AxeWarriorEntity>> AXE_WARRIOR = ENTITY_TYPES.register("axe_warrior", () ->
            EntityType.Builder.<AxeWarriorEntity>of(AxeWarriorEntity::new, EntityClassification.MONSTER)
                    .sized(0.7F, 1.98F)
                    .clientTrackingRange(8)
                    .setCustomClientFactory((spawnEntity,world) -> new AxeWarriorEntity(world))
                    .build(new ResourceLocation(MODID, "axe_warrior").toString())
    );
    ...
    public static final RegistryObject<EntityType<LeapleafEntity>> LEAPLEAF = ENTITY_TYPES.register("leapleaf", () ->
            EntityType.Builder.<LeapleafEntity>of(LeapleafEntity::new, EntityClassification.MONSTER)
                    .sized(2.02F, 1.81F * 1.25F) // 42 px wide, 29px tall
                    .clientTrackingRange(10)
    ...
    public static final RegistryObject<EntityType<DungeonsVexEntity>> VEX = ENTITY_TYPES.register("vex", () ->
            EntityType.Builder.<DungeonsVexEntity>of(DungeonsVexEntity::new, EntityClassification.MONSTER)
                    .sized(0.4F, 0.8F)
                    .clientTrackingRange(8)
                    .build(new ResourceLocation(MODID, "vex").toString())
    );
}
