...
public enum BiomeSpecificRaider {
	MOUNTAINEER(ModEntityTypes.MOUNTAINEER.get(), EntityType.VINDICATOR, BiomeTags.MOUNTAINEER_SPAWN_BIOMES),
	ICEOLOGER(ModEntityTypes.ICEOLOGER.get(), EntityType.EVOKER, BiomeTags.ICEOLOGER_SPAWN_BIOMES),
	WINDCALLER(ModEntityTypes.WINDCALLER.get(), EntityType.EVOKER, BiomeTags.WINDCALLER_SPAWN_BIOMES),
	SQUALL_GOLEM(ModEntityTypes.SQUALL_GOLEM.get(), EntityType.RAVAGER, BiomeTags.SQUALL_GOLEM_SPAWN_BIOMES),

	/*
	 * , ILLUSIONER( EntityType.ILLUSIONER, EntityType.ILLUSIONER,
